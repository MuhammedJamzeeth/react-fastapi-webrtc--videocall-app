...
const Home = () => {
    ...
    const {sendMessage, messages, activeUsers} =
        useWebSocket({
            ...
            <div className="container mx-auto pt-8">
                ...
                <section className="bg-black shadow-md rounded-lg w-full">
                    <nav className="bg-[#242526] p-1 h-12">
                        <div className="flex justify-center items-center">
                            <div className="flex items-center">
                                <div className="group">
                                    <div
                                        className="group-hover:bg-gray-600 p-1 inline-flex justify-center group-hover:rounded-lg transition-all ease-in-out duration-300 text-[12px]">
                                        Quest Meeting Title
                                        {/* <FaUsers />0 */}
                                    </div>
                  ...
                  <div className="absolute group-hover:border-b-2 group-hover:cursor-pointer mt-2 border-blue-500 w-full transition-all duration-100 ease-in-out "></div>
                                ...
                                <div className="group">
                                    <div
                                        className="group-hover:bg-gray-600 pt-2 pl-3 group-hover:rounded-lg transition-all ease-in-out duration-300">
                                        <FaRightFromBracket/>
                                    </div>
                                    <div
                                        className=" group-hover:border-b-2 group-hover:cursor-pointer mt-2 border-blue-500 w-full transition-all duration-100 ease-in-out"></div>
                                </div>
                            </div>
                        </div>
                    </nav>
                    ...
                    <nav className="bg-[#242526] p-1 h-12">
                        <div className="flex justify-center items-center">
                            <div className="relative flex justify-between w-1/5 items-center">
                                <div className="relative group">
                                    <div
                                        className="group-hover:bg-gray-600 p-1 group-hover:rounded-lg transition-all ease-in-out duration-300">
                                        <FaFaceSmile/>
                                    </div>
                                    <div
                                        className="absolute group-hover:border-b-2 group-hover:cursor-pointer mt-2 border-blue-500 w-full transition-all duration-100 ease-in-out "></div>
                                </div>
                                <div className="relative group">
                                    <div
                                        className="group-hover:bg-gray-600 p-1 group-hover:rounded-lg transition-all ease-in-out duration-300">
